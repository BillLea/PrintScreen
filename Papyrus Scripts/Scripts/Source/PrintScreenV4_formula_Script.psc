Scriptname PrintScreenV4_formula_Script extends Quest
...
string Function PrintScreenV4( int Validate, String Path, String ImageType, float Compression ) global native